        ...
        <div className="flex flex-col gap-10 md:gap-20 mr-1 ml-1 md:mr-16 md:ml-16 lg:mr-28 lg:ml-28 lato-regular">
          <div className="flex flex-col gap-16 lg:flex-row justify-between">
            <div className="flex gap-10 md:gap-32 w-full md:w-5/12">
              <div className="w-7/12 md:w-full">
                <NavLink to="/">
                  <div className="flex items-center ">
                    ...
                    <p className="oleo-script-regular text-3xl -mt-2">
                      gr<span className="text-[#FE9C00]">o</span>cery
                      <span className="text-[#FE9C00]">.</span>
                    </p>
                  </div>
                </NavLink>
                <p className="text-sm md:text-md w-full font-light pt-5 pb-5 leading-tight">
              ...
              <div className="flex flex-col gap-5 text-[12px] md:text-[16px]  w-5/12 md:w-full">
            ...
            <div className="flex w-full gap-10 md:w-5/12 md:gap-32">
              <div className="flex flex-col gap-5 text-[12px] md:text-[16px]">
                ...
                <ul className="flex flex-col gap-2">
                  ...
                  <li>
                    <NavLink to="/shop/fruits">Fruit</NavLink>
                  </li>
                  <li>
                    <NavLink to="/shop/meats">Meat</NavLink>
                  </li>
                  <li>
                    <NavLink to="/shop/fish">Fish</NavLink>
                  </li>
                  <li>
                    <NavLink to="/shop/milk&dairy">Milk & Dairy</NavLink>
                  </li>
                  <li>
                    <NavLink to="/coffee&drinks">Coffee & Drinks</NavLink>
                  </li>
                  <li>
                    <NavLink to="/grocery">Grocery</NavLink>
                  </li>
                  <li>
                    <NavLink to="/petfood">Pet Food</NavLink>
                  </li>
                  <li>
                    <NavLink to="/cleaningessentials">
                      Cleaning Essentials
                    </NavLink>
                  </li>
                </ul>
            ...
            <div className="flex flex-col items-center md:items-start gap-5 text-[12px] md:text-[16px]">
              ...
              <ul className="flex gap-3">
                <li className="border p-1 rounded-sm cursor-pointer">
                  <Link to="/">
                    <FaInstagram />
                  </Link>
                </li>
