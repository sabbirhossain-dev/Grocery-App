...
const CartButton = () => {
  ...
  return (
    <>
      <div className="bg-[#E9F5E9] shadow-md text-md px-2 py-2 md:text-3xl md:px-4 md:py-4 rounded-l-md fixed z-50 top-1/2 -translate-y-1/2 right-0 text-[#2e5207]">
        <button
        ...
        >
          ...
          <BsCart />
          <span>
            <p className="text-[10px] md:text-sm relative">
              {totalCount} items
            </p>
          </span>
        </button>
        ...
        <div className="w-1/3 flex justify-self-end fixed top-28 right-0 z-50">
          ...
          >
            <div className="text-right ">
              <button
                className="p-2 px-6 bg-red-600 hover:bg-red-800 transition-all duration-300 text-white"
                onClick={() => {
                  setItemToggle(false);
                }}
              >
