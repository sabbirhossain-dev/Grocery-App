        ...
        <div className="mr-8 ml-8 md:mr-16 md:ml-16 lg:mr-28 lg:ml-28 ">
          ...
          <div className="md:hidden flex justify-between items-center">
            <div className=" flex gap-3 items-center ">
              <NavLink to="/">
                <div className="flex justify-center items-center ">
                  ...
                  <p className="oleo-script-regular text-3xl text-[#075212] -mt-2">
            ...
            <div className="flex gap-6">
              ...
              <button
                className="text-[#075212] bg-[#E9F5E9] p-[5px] border border-[#FE9C00] shadow-sm  rounded-md"
                onClick={() => {
          ...
          {menuToggle && (
            ...
            >
              <ul className="flex flex-col justify-center pl-16 p-5 pb-10 rounded-md mt-2 w-full gap-7 text-md">
                ...
                <li
                  className="relative"
                  onClick={() => setMobilePageOpen((prev) => !prev)}
                >
                  <NavLink
                    to="/pages"
                    className={({ isActive }) =>
