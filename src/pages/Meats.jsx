  ...
  return (
    <section>
      <div className="text-center">
        <BannerTitle
          title="Find the Product you need from our Vast Collection"
          image={assets.shopbanner}
        />
      </div>
      ...
      <div className="pt-10 pb-20 font-semibold bg-white">
        <div className="flex justify-center items-center">
          <h2 className="text-3xl text-[#075212] pb-10">Meats</h2>
        </div>
              ...
              <div className="w-full md:w-3/12 flex flex-col gap-5">
                ...
                <div className="">
                  <div className="flex justify-between bg-[#E9F5E9] p-3">
                    ...
                    <button
                      className="text-[#075212] border-none"
                      onClick={() => {
                      ...
                      categoriesPriceList.map((cat) => (
                        <div className="flex items-center gap-2 py-1" key={cat}>
                          <input
                            ...
                            className="accent-green-600 h-4 w-4"
                          />
                          <p className="text-[14px] md:text-[14px] text-[#075212] lato-regular font-medium">
                            {cat}
                          </p>
                        </div>
                      ))}
