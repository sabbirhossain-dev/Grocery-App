        ...
        <div className="mr-10 ml-10 md:mr-16 md:ml-16 lg:mr-28 lg:ml-28">
          <div className="flex flex-col gap-7 md:flex-row justify-between items-center">
            <div className="w-full lg:w-1/2">
              ...
              <p className="text-[#075212] lato-regular text-sm md:text-md pt-6 pb-6">
                Lorem ipsum dolor sit amet consectetur. Elementum proin odio
                tincidunt viverra. Mollis vitae lorem tempor pellentesque mi
                mauris quisque ac. Nibh placerat augue eget iaculis bibendum
            ...
            <div className="relative w-full md:w-[450px] h-auto mt-10 md:mt-0 flex justify-center items-center">
              <img
                src={assets.banner}
                alt="Banner"
              ...
              <img
                ...
                alt="Overlay"
                className="absolute left-1/2 top-[57%] -translate-x-1/2 -translate-y-1/2 w-11/12 md:w-[450px] h-auto p-[2px]"
              />
            </div>

            {/* <div className="relative w-full md:w-[450px] mt-10 md:mt-0 flex items-center justify-center">
              <img
                src={assets.banner}
                alt="Banner"
                className="w-11/12 md:w-full"
              ...
              <img
                src={assets.bannerImg}
                alt="Overlay"
                className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-10/12 md:w-60 lg:w-[450px]"
              />
            </div> */}
          </div>
        </div>
