          ...
          <div className="grid grid-cols-2 md:grid-cols-2 lg:grid-cols-4 gap-5 md:gap-20">
            <div className="flex flex-col md:flex-row gap-2 w-full md:w-1/4">
              <img
                ...
                alt="logo"
                className="h-9 w-8 md:h-8 mt-1"
              />
              <div className="flex flex-col gap-2">
                <p className="lato-bold text-[14px] md:text-[24px] text-white tracking-wide">
                  Premium Quality
                </p>
                <p className="lato-regular text-[10px] md:text-[14px] text-white w-36 md:w-56 leading-5">
                  Lorem ipsum dolor sit amet consectetur. Et blandit eget
                  metus{" "}
                </p>
              </div>
            </div>
            ...
            <div className="flex flex-col md:flex-row gap-2 w-full md:w-1/4">
              <img
                src={assets.aboutlogo2}
                alt="logo"
                className="h-8 w-8 md:h-8 mt-1"
              />
              <div className="flex flex-col gap-2">
                <p className="lato-bold text-[14px] md:text-[24px] text-white tracking-wide">
                  Free Delivery
            ...
            <div className="flex flex-col md:flex-row gap-2 w-full md:w-1/4">
              <img
                src={assets.aboutlogo3}
                alt="logo"
                className="h-7 w-8 md:h-8 mt-1"
              />
              <div className="flex flex-col gap-2">
                <p className="lato-bold text-[14px] md:text-[24px] text-white tracking-wide">
                  Best Price & Offer
            ...
            <div className="flex flex-col md:flex-row gap-2 w-full md:w-1/4">
              <img
                src={assets.aboutlogo4}
                alt="logo"
                className="h-6 w-8 md:h-8 mt-1"
              />
              <div className="flex flex-col gap-2">
                <p className="lato-bold text-[14px] md:text-[24px] text-white tracking-wide">
                  Easy Return
