            ...
            <div className='grid grid-cols-2 md:grid-cols-2 lg:grid-cols-4 gap-5 md:gap-20'>
              ...
              <img src={assets.aboutlogo1} alt='logo' className='h-6 md:h-8 mt-1'/>
                <div className='flex flex-col gap-2'>
                  <p className='lato-bold text-[14px] md:text-[24px] text-white tracking-wide'>Premium Quality</p>
                  <p className='lato-regular text-[10px] md:text-[14px] text-white w-36 md:w-56 leading-5'>Lorem ipsum dolor sit amet consectetur. Et blandit eget metus  </p>
                </div>
              </div>
              ...
              <img src={assets.aboutlogo2} alt='logo' className='h-6 md:h-8 mt-1'/>
                <div className='flex flex-col gap-2'>
                 <p className='lato-bold text-[14px] md:text-[24px] text-white tracking-wide'>Free Delivery</p>
                  <p className='lato-regular text-[10px] md:text-[14px] text-white w-36 md:w-56 leading-5'>Lorem ipsum dolor sit amet consectetur. Et blandit eget metus  </p>
                </div>
              </div>
              ...
              <img src={assets.aboutlogo3} alt='logo' className='h-6 md:h-8 mt-1'/>
                <div className='flex flex-col gap-2'>
                 <p className='lato-bold text-[14px] md:text-[24px] text-white tracking-wide'>Best Price & Offer</p>
                  <p className='lato-regular text-[10px] md:text-[14px] text-white w-36 md:w-56 leading-5'>Lorem ipsum dolor sit amet consectetur. Et blandit eget metus  </p>
                </div>
              </div>
              ...
              <img src={assets.aboutlogo4} alt='logo' className='h-6 md:h-8 mt-1'/>
                <div className='flex flex-col gap-2'>
                 <p className='lato-bold text-[14px] md:text-[24px] text-white tracking-wide'>Easy Return</p>
                  <p className='lato-regular text-[10px] md:text-[14px] text-white w-36 md:w-56 leading-5'>Lorem ipsum dolor sit amet consectetur. Et blandit eget metus  </p>
                </div>
              </div>
